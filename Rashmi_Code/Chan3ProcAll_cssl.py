...
# File Pair Discovery
# ============================================================
def find_file_pairs(infolder, prefix, suffix_ch0, suffix_ch1):
    """
    Find matched pairs of channel 0 and channel 1 files in a directory.
...
Examples:
  ...
  python3 Chan3ProcAll_cssl.py -i /data/raw/ -o /data/processed/ --fft_workers 8 -v --log run.log
    ...
    if args.debug:
        ...
        pairs = find_file_pairs(args.infolder, args.prefix, args.suffix0, args.suffix1)

        if len(pairs) == 0:
            logger.error("No file pairs found. Check --infolder, --prefix, --suffix0, --suffix1.")
            sys.exit(1)
